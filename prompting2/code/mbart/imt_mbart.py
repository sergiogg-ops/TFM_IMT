"""
Prefix-Based Approach with Mbart
...
def translate(args):
	try:
		...
		file_name = '/dataset/europarl-inmt/{0}/test.{1}'.format(args.folder, args.target)
		trg_lines = read_file(file_name)
		#| PREPARE DOCUMENT TO WRITE
		file_name = '/dataset/europarl-inmt/{0}/imt_mbart.{1}'.format(args.folder, args.target)
		file_out = open(file_name, 'w')
		#|========================================================
		#| LOAD MODEL AND TOKENIZER
		model_path = args.model
		model = MBartForConditionalGeneration.from_pretrained(model_path).to(device)
		tokenizer = MBart50TokenizerFast.from_pretrained("./mbart-large-50-many-to-many-mmt", src_lang=args.source_code, tgt_lang=args.target_code)
		#|========================================================
