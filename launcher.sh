...
#python train.py -src gl -trg en -dir hplt/gl-en/ -model gemma -lora -bs 1
#python train.py -src en -trg gl -dir hplt/gl-en/ -model gemma -lora -bs 1
#python train.py -src gl -trg en -dir hplt/gl-en/ -model eurollm -lora -bs 1
#python train.py -src en -trg gl -dir hplt/gl-en/ -model eurollm -lora -bs 1

#python train.py -src sw -trg en -dir hplt/sw-en/ -model gemma -lora -bs 1
#python train.py -src en -trg sw -dir hplt/sw-en/ -model gemma -lora -bs 1
#python train.py -src sw -trg en -dir hplt/sw-en/ -model eurollm -lora -bs 1
#python train.py -src en -trg sw -dir hplt/sw-en/ -model eurollm -lora -bs 1

#python train.py -src ca -trg en -dir hplt/ca-en/ -model gemma -lora -bs 1
#python train.py -src en -trg ca -dir hplt/ca-en/ -model gemma -lora -bs 1
#python train.py -src ca -trg en -dir hplt/ca-en/ -model eurollm -lora -bs 1
#python train.py -src en -trg ca -dir hplt/ca-en/ -model eurollm -lora -bs 1
...
python bleu_ter.py -src sw -trg en -dir hplt/sw-en/ -p test -model gemma_swen/ -model_name gemma -b 1
#python bleu_ter.py -src sw -trg en -dir hplt/sw-en/ -p test -model eurollm_swen/ -model_name eurollm -b 1
python bleu_ter.py -src en -trg sw -dir hplt/sw-en/ -p test -model gemma_ensw/ -model_name gemma -b 1
#python bleu_ter.py -src en -trg sw -dir hplt/sw-en/ -p test -model eurollm_ensw/ -model_name eurollm -b 1
