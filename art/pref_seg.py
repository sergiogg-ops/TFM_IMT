...
def read_args():
    ...
    parser.add_argument('-m', '--models', default=['mbart','m2m','flant5','nllb', 'eurollm', 'gemma'], nargs='+', help='Models to compare')
...
def main():
    ...
    for model in tqdm(args.models, desc='Comprobando significatividad'):
        ...
        significance = significance._append({'model': model, 'src': args.pair[:2], 'trg': args.pair[2:], 
                                                'sig_wsr': sig_wsr, 'sig_mar': sig_mar}, ignore_index=True)
